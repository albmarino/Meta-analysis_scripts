...
total_sp=$(grep '>' *$suff | grep -vF -f sp2rm | cut -d'>' -f2| sort -u |wc -l)
actinopteri_sp=$(grep '>' $act_pref*$suff |cut -d'>' -f2| sort -u |wc -l)
aves_sp=$(grep '>' $ave_pref*$suff |cut -d'>' -f2| sort -u |wc -l)
insecta_sp=$(grep '>' $ins_pref*$suff |cut -d'>' -f2| sort -u |wc -l)
mammalia_sp=$(grep '>' $mam_pref*$suff |cut -d'>' -f2| sort -u |wc -l)
mollusca_sp=$(grep '>' $mol_pref*$suff |cut -d'>' -f2| sort -u |wc -l)
...
computeSeqStat $act_pref$gene$suff fasta GC | cut -d',' -f6 | sed '1d'> gc3temp_actinopteri
computeSeqStat ~/alignedbusco_phylogenies/aligned_busco/extractbusco_actinopteri/${gene}_prealign_species_NT.fasta fasta missing_data | cut -d',' -f5 > missingdatatemp_actinopteri

computeSeqStat $ave_pref$gene$suff fasta GC | cut -d',' -f6 | sed '1d'> gc3temp_aves
computeSeqStat ~/alignedbusco_phylogenies/aligned_busco/extractbusco_aves/${gene}_prealign_species_NT.fasta fasta missing_data | cut -d',' -f5 > missingdatatemp_aves

computeSeqStat $ins_pref$gene$suff fasta GC | cut -d',' -f6 | sed '1d'> gc3temp_insecta
computeSeqStat ~/alignedbusco_phylogenies/aligned_busco/extractbusco_insecta/${gene}_prealign_species_NT.fasta fasta missing_data | cut -d',' -f5 > missingdatatemp_insecta

computeSeqStat $mam_pref$gene$suff fasta GC | cut -d',' -f6 | sed '1d'> gc3temp_mammalia
computeSeqStat ~/alignedbusco_phylogenies/aligned_busco/extractbusco_mammalia/${gene}_prealign_species_NT.fasta fasta missing_data | cut -d',' -f5 > missingdatatemp_mammalia

computeSeqStat $mol_pref$gene$suff fasta GC | cut -d',' -f6 | sed '1d'> gc3temp_mollusca
computeSeqStat ~/alignedbusco_phylogenies/aligned_busco/extractbusco_mollusca/${gene}_prealign_species_NT.fasta fasta missing_data | cut -d',' -f5 > missingdatatemp_mollusca
...
if [ ! -s gc3temp_actinopteri ]; then
	...
	nsp_actinopteri=$(grep -c '>' $act_pref$gene$suff)
...
if [ ! -s gc3temp_aves ]; then
	...
	vargc_aves="NA"
        ...
        nsp_aves=$(grep -c '>' $ave_pref$gene$suff)
...
if [ ! -s gc3temp_insecta ]; then
        ...
        nsp_insecta=$(grep -c '>' $ins_pref$gene$suff)
...
if [ ! -s gc3temp_mammalia ]; then
	...
	nsp_mammalia=$(grep -c '>' $mam_pref$gene$suff)
...
if [ ! -s gc3temp_mollusca ]; then
	...
	nsp_mollusca=$(grep -c '>' $mol_pref$gene$suff)
